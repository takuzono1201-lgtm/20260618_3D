[index.html](https://github.com/user-attachments/files/29087974/index.html)
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
  ...
  <div id="popupbody">
    ...
    <div id="pageinfo">
      ...
      <div id="about"><img src="./Qgis2threejs.png">
        This page was made with <a href="https://www.qgis.org/">QGIS</a> and <a href="https://github.com/minorua/Qgis2threejs">Qgis2threejs</a> plugin (version 3.0).
...
app.loadSceneFile("./data/index/scene.js", function (scene) {
  ...
  // all associated files have been loaded
